...
> ✅ **重大突破**：基于2019-2026历史数据验证，**三ETF轮动策略**年化16.4%，超额+4.7% vs BH等权。MA策略在熊市防跌有效，但牛市踏空。Dashboard v2支持实时监控。

> ⚠️ **重要发现**：2019-2026全区间(7.4年)，MA策略整体跑输BH——主要因2020疫情牛市踏空。策略核心价值：**熊市防跌**，牛市建议直接持有。

## 历史验证结论（2019-01 ~ 2026-05，共1778交易日）

| 策略 | 年化 | vs BH | 夏普 | 最大回撤 | 结论 |
|------|------|-------|------|---------|------|
| 创业板 MA(15/20) | 13.9% | -63.6% | 0.88 | -19.8% | ⚠️牛市踏空 |
| 中证500 MA(5/20) | 8.3% | -19.4% | 0.67 | -27.6% | ⚠️牛市踏空 |
| 沪深300 MA(3/20) | 4.3% | -25.9% | 0.43 | -24.7% | ⚠️牛市踏空 |
| 🔄 三ETF轮动 | 16.4% | **+4.7%** | - | - | ✅ 最优策略 |

**分段表现**：熊市(2019-2023)年化4-9%，牛市(2024-2026)年化16-37%。轮动策略在牛市超额最显著。
